...
class InfernalPlayState extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('z_lists/fpInfernallist'));
	...
	function changeDiff(change:Int = 0)
	{
		...
		if (songs[curSelected].songName.contains("BLOODSHED-TWO"))
		{
			if (curDifficulty < 2)
				curDifficulty = 2;
			if (curDifficulty > 2)
