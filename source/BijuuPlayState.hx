...
class BijuuPlayState extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('z_lists/fpBijuulist'));
		...
		var initCoolList = CoolUtil.coolTextFile(Paths.txt('z_lists/fpBijuulist'));
		...
		var initBsideList = CoolUtil.coolTextFile(Paths.txt('z_lists/fpBsideBijuulist'));
	...
	function modeSwap()
	{
		...
		switch (curSelected)
		{
			case 1: bg.color = FlxColor.LIME;
			case 2: bg.color = FlxColor.LIME;
	...
	function modeSwapA()
	{
		...
		switch (curSelected)
		{
			case 1: bg.color = FlxColor.LIME;
			case 2: bg.color = FlxColor.LIME;
			case 3: bg.color = FlxColor.LIME;
			case 4: bg.color = FlxColor.LIME;
			case 5: bg.color = FlxColor.LIME;
