...
class ShuttlePlayState extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('z_lists/fpShuttlelist'));
		...
		DiscordClient.currentIcon = "normal";
		 DiscordClient.changePresence("In the Freeplay Menu (Shuttle Man)", null);
		 #end
