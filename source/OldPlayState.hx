...
class OldPlayState extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('freeplaySonglisto'));
		...
		DiscordClient.currentIcon = "normal";
		 DiscordClient.changePresence("In the Freeplay Menu (Old)", null);
		 #end
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menuBGold'));
		add(bg);
	...
	override function update(elapsed:Float)
	{
		...
		if (songs[curSelected].songName == 'BLOODSHED-TWO' || songs[curSelected].songName.toLowerCase() == 'raw' || songs[curSelected].songName.toLowerCase() == 'uncooked-meat' || songs[curSelected].songName.toLowerCase() == 'assassinate' || songs[curSelected].songName.toLowerCase() == 'oh-god-oh-fuck')
		{
	...
	function changeDiff(change:Int = 0)
	{
		...
		if (songs[curSelected].songName.toLowerCase() == 'raw' || songs[curSelected].songName.toLowerCase() == 'uncooked-meat' || songs[curSelected].songName.toLowerCase() == 'assassinate' || songs[curSelected].songName.toLowerCase() == 'oh-god-oh-fuck')
		{
			curDifficulty = 2;
		}
		else
